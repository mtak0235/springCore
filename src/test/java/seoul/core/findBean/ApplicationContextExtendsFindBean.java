...
class ApplicationContextExtendsFindBean {
    ...
    void findBeanByParentTypeBeanName() {
        ...
        ObjectAssert<DiscountPolicy> instanceOf = assertThat(rateDiscountPolicy).isInstanceOf(RateDiscountPolicy.class);
    }
    @Test
